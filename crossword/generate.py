...
class CrosswordCreator():
        ...
        for v, word in assignment.items():
            ...
            for n in self.crossword.neighbors(v):
                if n in assignment:
                    ...
                    if assignment[n][overlap[1]] != word[overlap[0]]:
                        return False
        return True
    ...
    def order_domain_values(self, var, assignment):
        ...
        values.sort(key=lambda value: self.num_ruled_out(var, value, assignment))
        return values
    
    def num_ruled_out(self, var, value, assignment):
        ruled_out = 0
